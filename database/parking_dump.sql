...
\restrict Dfvf4lmMjLX2hmm1N7qvf5XE5lzFuAz7fCP60odoQXOZ74rHk1xzgZ5OaFGSbwd
...
CREATE TABLE public.admins (
    ...
    CONSTRAINT admins_role_check CHECK (((role)::text = ANY (ARRAY[('superadmin'::character varying)::text, ('admin'::character varying)::text, ('operator'::character varying)::text])))
);
...
CREATE TABLE public.authorizations (
    ...
    delegate_face_image character varying(500),
    delegate_embedding real[],
    ...
    CONSTRAINT authorization_has_delegate CHECK (((delegate_face_image IS NOT NULL) OR (delegate_user_id IS NOT NULL))),
    CONSTRAINT authorizations_auth_type_check CHECK (((auth_type)::text = ANY (ARRAY[('once'::character varying)::text, ('daily'::character varying)::text, ('permanent'::character varying)::text])))
);
...
CREATE TABLE public.devices (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT devices_device_type_check CHECK (((device_type)::text = ANY (ARRAY[('camera_face'::character varying)::text, ('camera_plate'::character varying)::text, ('barrier'::character varying)::text, ('sensor'::character varying)::text, ('led'::character varying)::text, ('speaker'::character varying)::text, ('arduino'::character varying)::text, ('computer'::character varying)::text]))),
    CONSTRAINT devices_lane_check CHECK (((lane)::text = ANY (ARRAY[('entry'::character varying)::text, ('exit'::character varying)::text, ('both'::character varying)::text]))),
    CONSTRAINT devices_status_check CHECK (((status)::text = ANY (ARRAY[('online'::character varying)::text, ('offline'::character varying)::text, ('error'::character varying)::text, ('maintenance'::character varying)::text])))
);
...
CREATE TABLE public.event_logs (
    ...
    metadata jsonb,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT event_logs_session_kind_check CHECK (((session_kind)::text = ANY (ARRAY[('member'::character varying)::text, ('guest'::character varying)::text])))
);
...
CREATE TABLE public.fcm_tokens (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT fcm_tokens_device_type_check CHECK (((device_type)::text = ANY (ARRAY[('android'::character varying)::text, ('ios'::character varying)::text, ('web'::character varying)::text])))
);
...
CREATE TABLE public.guest_sessions (
    ...
    CONSTRAINT guest_sessions_payment_gateway_check CHECK (((payment_gateway)::text = ANY (ARRAY[('vnpay'::character varying)::text, ('momo'::character varying)::text, ('zalopay'::character varying)::text, ('cash_qr'::character varying)::text]))),
    CONSTRAINT guest_sessions_payment_status_check CHECK (((payment_status)::text = ANY (ARRAY[('pending'::character varying)::text, ('paid'::character varying)::text, ('failed'::character varying)::text]))),
    CONSTRAINT guest_sessions_status_check CHECK (((status)::text = ANY (ARRAY[('active'::character varying)::text, ('completed'::character varying)::text, ('abnormal'::character varying)::text])))
);
...
CREATE TABLE public.manual_overrides (
    ...
    CONSTRAINT manual_overrides_action_check CHECK (((action)::text = ANY (ARRAY[('open_barrier'::character varying)::text, ('close_barrier'::character varying)::text, ('end_session'::character varying)::text, ('unlock_account'::character varying)::text, ('force_exit'::character varying)::text])))
);
...
CREATE TABLE public.monthly_passes (
    ...
    CONSTRAINT monthly_passes_status_check CHECK (((status)::text = ANY (ARRAY[('active'::character varying)::text, ('expired'::character varying)::text, ('cancelled'::character varying)::text])))
);
...
CREATE TABLE public.notifications (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT notifications_type_check CHECK (((type)::text = ANY (ARRAY[('vehicle_entry'::character varying)::text, ('vehicle_exit'::character varying)::text, ('fee_deducted'::character varying)::text, ('topup_success'::character varying)::text, ('low_balance'::character varying)::text, ('withdraw_success'::character varying)::text, ('session_abnormal'::character varying)::text, ('auth_granted'::character varying)::text, ('system'::character varying)::text])))
);
...
CREATE TABLE public.parking_sessions (
    ...
    CONSTRAINT parking_sessions_session_type_check CHECK (((session_type)::text = ANY (ARRAY[('member'::character varying)::text, ('authorized'::character varying)::text]))),
    CONSTRAINT parking_sessions_status_check CHECK (((status)::text = ANY (ARRAY[('active'::character varying)::text, ('completed'::character varying)::text, ('abnormal'::character varying)::text, ('force_ended'::character varying)::text])))
);
...
CREATE TABLE public.report_exports (
    ...
    CONSTRAINT report_exports_file_format_check CHECK (((file_format)::text = ANY (ARRAY[('csv'::character varying)::text, ('xlsx'::character varying)::text, ('pdf'::character varying)::text]))),
    CONSTRAINT report_exports_status_check CHECK (((status)::text = ANY (ARRAY[('processing'::character varying)::text, ('completed'::character varying)::text, ('failed'::character varying)::text])))
);
...
CREATE TABLE public.sync_queue (
    ...
    CONSTRAINT sync_queue_entity_type_check CHECK (((entity_type)::text = ANY (ARRAY[('parking_session'::character varying)::text, ('guest_session'::character varying)::text, ('wallet_transaction'::character varying)::text, ('event_log'::character varying)::text, ('device_status'::character varying)::text, ('system_alert'::character varying)::text]))),
    ...
    CONSTRAINT sync_queue_status_check CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('syncing'::character varying)::text, ('synced'::character varying)::text, ('failed'::character varying)::text])))
);
...
CREATE TABLE public.system_alerts (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT system_alerts_alert_type_check CHECK (((alert_type)::text = ANY (ARRAY[('device_offline'::character varying)::text, ('arduino_disconnected'::character varying)::text, ('session_abnormal'::character varying)::text, ('lot_full'::character varying)::text, ('low_balance_user'::character varying)::text, ('sync_failed'::character varying)::text, ('auth_anomaly'::character varying)::text, ('barrier_stuck'::character varying)::text, ('camera_error'::character varying)::text]))),
    CONSTRAINT system_alerts_severity_check CHECK (((severity)::text = ANY (ARRAY[('info'::character varying)::text, ('warning'::character varying)::text, ('critical'::character varying)::text]))),
    CONSTRAINT system_alerts_status_check CHECK (((status)::text = ANY (ARRAY[('unresolved'::character varying)::text, ('resolved'::character varying)::text, ('ignored'::character varying)::text])))
);
...
CREATE TABLE public.system_configs (
    ...
    updated_by uuid,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT system_configs_data_type_check CHECK (((data_type)::text = ANY (ARRAY[('string'::character varying)::text, ('integer'::character varying)::text, ('decimal'::character varying)::text, ('boolean'::character varying)::text, ('json'::character varying)::text])))
);
...
CREATE TABLE public.user_face_images (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    angle character varying(10),
    CONSTRAINT user_face_images_angle_check CHECK (((angle)::text = ANY ((ARRAY['front'::character varying, 'left'::character varying, 'right'::character varying, 'up'::character varying, 'down'::character varying])::text[]))),
    CONSTRAINT user_face_images_status_check CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('processing'::character varying)::text, ('processed'::character varying)::text, ('failed'::character varying)::text])))
);
...
CREATE TABLE public.wallet_transactions (
    ...
    CONSTRAINT wallet_transactions_payment_gateway_check CHECK (((payment_gateway)::text = ANY (ARRAY[('vnpay'::character varying)::text, ('momo'::character varying)::text, ('zalopay'::character varying)::text, ('bank_transfer'::character varying)::text, ('system'::character varying)::text]))),
    CONSTRAINT wallet_transactions_status_check CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('success'::character varying)::text, ('failed'::character varying)::text, ('cancelled'::character varying)::text]))),
    CONSTRAINT wallet_transactions_transaction_type_check CHECK (((transaction_type)::text = ANY (ARRAY[('topup'::character varying)::text, ('deduct'::character varying)::text, ('withdraw'::character varying)::text, ('refund'::character varying)::text])))
);
...
CREATE TABLE public.withdraw_requests (
    ...
    CONSTRAINT withdraw_requests_status_check CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('processing'::character varying)::text, ('completed'::character varying)::text, ('rejected'::character varying)::text])))
);
...
79cfb6e9-89ff-44d2-a4aa-e0ce59611521	a1166982-3803-4093-aa6d-04c2c8976ee5	5aa8c142bf706b2e2a050d0997962af24d875fffde0788365a2e662c3356912b	::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36	2026-05-12 09:23:27.003989+07	\N	2026-05-12 01:23:27.003989+07
3632da9a-f8c8-40ed-b290-944b217e3a5b	a1166982-3803-4093-aa6d-04c2c8976ee5	df01518e8dd019364666ad65aff75639474b2ba2af97a71d83601c4d547341a0	::1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36	2026-05-12 22:37:06.662047+07	2026-05-12 14:59:22.422857+07	2026-05-12 14:37:06.662047+07
\.
...
COPY public.authorizations (auth_id, vehicle_id, owner_user_id, delegate_name, delegate_face_image, delegate_embedding, auth_type, valid_from, valid_until, is_active, is_consumed, consumed_at, model_version, created_at, delegate_user_id) FROM stdin;
\.
...
40302fbc-d579-4968-800f-c246f7ca0789	\N	session_force_ended	dd000001-0000-0000-0000-000000000005	\N	\N	a1166982-3803-4093-aa6d-04c2c8976ee5	\N	51K-321.00	Kết thúc cưỡng bức (vãng lai): SGSG	\N	2026-05-12 01:24:03.717589+07
51797e08-380e-4c62-9c88-9c173d333661	\N	session_force_ended	dd000001-0000-0000-0000-000000000001	\N	\N	a1166982-3803-4093-aa6d-04c2c8976ee5	\N	52F-445.67	Kết thúc cưỡng bức (vãng lai): SGSG	\N	2026-05-12 01:24:07.388319+07
7f35435f-30d5-4bcb-b4c0-84d4ba2375f9	\N	session_force_ended	cc000001-0000-0000-0000-000000000001	\N	\N	a1166982-3803-4093-aa6d-04c2c8976ee5	\N	29B1-12345	Kết thúc cưỡng bức: SGS	\N	2026-05-12 01:24:10.093672+07
385991d5-f802-495b-8648-d3bbaf309c31	\N	session_force_ended	cc000002-0000-0000-0000-000000000001	\N	\N	a1166982-3803-4093-aa6d-04c2c8976ee5	\N	51F-11111	Kết thúc cưỡng bức: SGSG	\N	2026-05-12 01:24:13.07743+07
\.
...
COPY public.guest_sessions (session_id, session_code, license_plate, lot_id, entry_time, exit_time, duration_minutes, entry_face_image_path, entry_plate_image_path, entry_composite_image_path, exit_composite_image_path, fee, payment_gateway, gateway_transaction_id, payment_status, paid_at, status, abnormal_reason, entry_device_id, exit_device_id, is_synced, created_at, updated_at) FROM stdin;
dd000001-0000-0000-0000-000000000003	GX-260103	30H-888.99	c9f3967e-15ce-4010-8376-fac0ff9bacf3	2026-03-31 12:53:02.12005+07	\N	\N	\N	\N	\N	\N	\N	\N	\N	pending	\N	active	\N	\N	\N	f	2026-03-31 15:43:02.12005+07	2026-03-31 15:43:02.12005+07
dd000001-0000-0000-0000-000000000004	GX-260104	\N	c9f3967e-15ce-4010-8376-fac0ff9bacf3	2026-03-31 15:25:02.12005+07	2026-03-31 21:30:44.359785+07	\N	\N	\N	\N	\N	\N	\N	\N	pending	\N	abnormal	a	\N	\N	f	2026-03-31 15:43:02.12005+07	2026-03-31 21:30:44.359785+07
dd000001-0000-0000-0000-000000000002	GX-260102	51B-112.23	c9f3967e-15ce-4010-8376-fac0ff9bacf3	2026-03-31 15:08:02.12005+07	2026-04-01 21:03:44.970021+07	1795	\N	\N	\N	\N	\N	\N	\N	pending	\N	abnormal	a	\N	\N	f	2026-03-31 15:43:02.12005+07	2026-04-01 21:03:44.970021+07
dd000001-0000-0000-0000-000000000005	GX-260105	51K-321.00	c9f3967e-15ce-4010-8376-fac0ff9bacf3	2026-03-31 14:48:02.12005+07	2026-05-12 01:24:03.706431+07	59676	\N	\N	\N	\N	\N	\N	\N	pending	\N	abnormal	SGSG	\N	\N	f	2026-03-31 15:43:02.12005+07	2026-05-12 01:24:03.706431+07
dd000001-0000-0000-0000-000000000001	GX-260101	52F-445.67	c9f3967e-15ce-4010-8376-fac0ff9bacf3	2026-03-31 14:35:02.12005+07	2026-05-12 01:24:07.373799+07	59689	\N	\N	\N	\N	\N	\N	\N	pending	\N	abnormal	SGSG	\N	\N	f	2026-03-31 15:43:02.12005+07	2026-05-12 01:24:07.373799+07
\.
...
c9f3967e-15ce-4010-8376-fac0ff9bacf3	Bãi Xe Thông Minh – Trường ĐH Hàng Hải Việt Nam	484 Lạch Tray, Đổng Quốc Bình, Lê Chân, Hải Phòng	100	3	0225-3829-250	baixe@vimaru.edu.vn	t	2026-03-31 14:36:19.334925+07	2026-05-12 01:24:13.075354+07
\.
...
COPY public.parking_sessions (session_id, vehicle_id, user_id, auth_id, session_type, license_plate, lot_id, entry_time, exit_time, duration_minutes, entry_face_image_path, entry_plate_image_path, entry_composite_image_path, exit_face_image_path, exit_plate_image_path, exit_composite_image_path, fee, wallet_transaction_id, status, abnormal_reason, force_ended_by, force_end_reason, entry_device_id, exit_device_id, is_synced, created_at, updated_at) FROM stdin;
cc000001-0000-0000-0000-000000000002	b1b2c3d4-0000-0000-0000-000000000002	a1b2c3d4-0000-0000-0000-000000000001	\N	member	30A-98765	c9f3967e-15ce-4010-8376-fac0ff9bacf3	2026-03-31 15:13:02.12005+07	2026-03-31 21:30:39.447375+07	\N	\N	\N	\N	\N	\N	\N	\N	\N	force_ended	\N	a1166982-3803-4093-aa6d-04c2c8976ee5	d	\N	\N	f	2026-03-31 15:43:02.12005+07	2026-03-31 21:30:39.447375+07
cc000001-0000-0000-0000-000000000001	b1b2c3d4-0000-0000-0000-000000000001	a1b2c3d4-0000-0000-0000-000000000001	\N	member	29B1-12345	c9f3967e-15ce-4010-8376-fac0ff9bacf3	2026-03-31 13:58:02.12005+07	2026-05-12 01:24:10.076609+07	59726	\N	\N	\N	\N	\N	\N	\N	\N	force_ended	\N	a1166982-3803-4093-aa6d-04c2c8976ee5	SGS	\N	\N	f	2026-03-31 15:43:02.12005+07	2026-05-12 01:24:10.076609+07
cc000002-0000-0000-0000-000000000001	b1b2c3d4-0000-0000-0000-000000000003	a1b2c3d4-0000-0000-0000-000000000002	\N	member	51F-11111	c9f3967e-15ce-4010-8376-fac0ff9bacf3	2026-03-31 13:23:02.12005+07	2026-05-12 01:24:13.073651+07	59761	\N	\N	\N	\N	\N	\N	\N	\N	force_ended	\N	a1166982-3803-4093-aa6d-04c2c8976ee5	SGSG	\N	\N	f	2026-03-31 15:43:02.12005+07	2026-05-12 01:24:13.073651+07
\.
...
ecc81e1f-404e-4939-b78e-56b25a82f956	b15f97c3-4d62-41f0-b455-2efa6c1ded29	4c7f0d070301369d9fc5befcfa3e294bd3fe28de4735d714755ad35d7e9498e5	Mozilla/5.0 (Windows NT; Windows NT 10.0; en-US) WindowsPowerShell/5.1.26100.8115	::1	2026-05-12 10:38:43.236692+07	\N	2026-05-12 02:38:43.236692+07
94828a4b-a8b1-4517-b6c7-a18f82d48539	b15f97c3-4d62-41f0-b455-2efa6c1ded29	b0bf54b62d60bb87e973e066727a813b4b00d48062a54374d20070ce737521d4	Mozilla/5.0 (Windows NT; Windows NT 10.0; en-US) WindowsPowerShell/5.1.26100.8115	::1	2026-05-12 10:40:20.32354+07	\N	2026-05-12 02:40:20.32354+07
84597aed-163e-4b76-bce1-72068aff801f	cb3be902-5237-4b0d-bd6b-adb839a64ab6	3ed445af1d97b081a93e0b0f4fbbfb239140626f316c8d2083ed77fc3439e438	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36	::1	2026-05-12 22:52:14.830148+07	2026-05-12 14:59:06.154956+07	2026-05-12 14:52:14.830148+07
\.
...
COPY public.user_face_images (image_id, user_id, image_path, status, embedding_id, note, created_at, updated_at, angle) FROM stdin;
f7d46258-a026-4c67-9627-f17c0a86fb64	cb3be902-5237-4b0d-bd6b-adb839a64ab6	faces/cb3be902-5237-4b0d-bd6b-adb839a64ab6/1774963532911.jpg	pending	\N	\N	2026-03-31 20:25:32.91588+07	2026-03-31 20:25:32.91588+07	\N
e550beb2-481a-4199-a9fa-cf1f3f6cefd8	b15f97c3-4d62-41f0-b455-2efa6c1ded29	faces/b15f97c3-4d62-41f0-b455-2efa6c1ded29/front.jpg	pending	\N	\N	2026-05-12 01:39:59.367507+07	2026-05-12 01:39:59.367507+07	front
9e65828a-22d3-46f9-ae97-8ba6c4884d92	b15f97c3-4d62-41f0-b455-2efa6c1ded29	faces/b15f97c3-4d62-41f0-b455-2efa6c1ded29/left.jpg	pending	\N	\N	2026-05-12 01:39:59.367507+07	2026-05-12 01:39:59.367507+07	left
dbeaa431-ad4e-4093-8309-8589cbcbf336	b15f97c3-4d62-41f0-b455-2efa6c1ded29	faces/b15f97c3-4d62-41f0-b455-2efa6c1ded29/right.jpg	pending	\N	\N	2026-05-12 01:39:59.367507+07	2026-05-12 01:39:59.367507+07	right
a0f522f4-e08f-46e1-9187-5d48996c698f	b15f97c3-4d62-41f0-b455-2efa6c1ded29	faces/b15f97c3-4d62-41f0-b455-2efa6c1ded29/up.jpg	pending	\N	\N	2026-05-12 01:39:59.367507+07	2026-05-12 01:39:59.367507+07	up
9836161d-1e33-42d1-8732-0a18be2413d2	b15f97c3-4d62-41f0-b455-2efa6c1ded29	faces/b15f97c3-4d62-41f0-b455-2efa6c1ded29/down.jpg	pending	\N	\N	2026-05-12 01:39:59.367507+07	2026-05-12 01:39:59.367507+07	down
\.
...
b15f97c3-4d62-41f0-b455-2efa6c1ded29	Ngô Quang Hiếu	0988888888	\N	$2a$12$VQEAR8511fQ0EZ.9jlGS3eUh5jJdfx.gGxy7UkKjaH80iSOw2.if.	\N	t	f	2026-05-12 01:37:36.307745+07	2026-05-12 01:37:36.307745+07
08bdddc8-ca91-4430-9f77-e445a6398121	Luong Minh hao	0987654321	\N	$2a$12$9qu28Wlx8TeIkzkm6e06S.GnWtNNohItjEV3ayqntKyLSWcdCxRy.	\N	t	f	2026-05-12 01:18:47.031461+07	2026-05-12 01:41:00.923604+07
\.
...
f93347a4-e70a-463a-ac80-dcc82024bf9b	b15f97c3-4d62-41f0-b455-2efa6c1ded29	15-B2748.53	plates/b15f97c3-4d62-41f0-b455-2efa6c1ded29/f93347a4-e70a-463a-ac80-dcc82024bf9b-1778524799426.jpg	xe đi làm	t	2026-05-12 01:39:59.367507+07	2026-05-12 01:39:59.367507+07
\.
...
fd0dfa3a-3e6a-4510-b48c-62ebf9bb7d29	3aa4e8c9-e96f-48bd-b5cb-0809cbc2011a	b15f97c3-4d62-41f0-b455-2efa6c1ded29	topup	200000.00	0.00	200000.00	momo	\N	\N	\N	\N	success	Nạp tiền vào ví	2026-05-12 01:40:09.28117+07	2026-05-12 01:40:09.28117+07
\.
...
abf394fa-f17c-41dc-bc5e-bcfab39adac9	08bdddc8-ca91-4430-9f77-e445a6398121	0.00	50000.00	2026-05-12 01:18:47.031461+07
3aa4e8c9-e96f-48bd-b5cb-0809cbc2011a	b15f97c3-4d62-41f0-b455-2efa6c1ded29	200000.00	50000.00	2026-05-12 01:40:09.28117+07
\.
...
--
-- Name: user_face_images uq_user_face_angle; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_auth_delegate_user; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_auth_delegate_user ON public.authorizations USING btree (delegate_user_id) WHERE (delegate_user_id IS NOT NULL);
...
--
-- Name: idx_guest_sessions_plate_active; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_guest_sessions_plate_active ON public.guest_sessions USING btree (license_plate) WHERE ((status)::text = 'active'::text);
...
--
-- Name: idx_parking_sessions_plate_active; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_parking_sessions_plate_active ON public.parking_sessions USING btree (license_plate) WHERE ((status)::text = 'active'::text);
...
CREATE INDEX idx_sync_queue_pending ON public.sync_queue USING btree (status, created_at) WHERE ((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('failed'::character varying)::text]));
...
--
-- Name: authorizations authorizations_delegate_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.authorizations
    ADD CONSTRAINT authorizations_delegate_user_id_fkey FOREIGN KEY (delegate_user_id) REFERENCES public.users(user_id) ON DELETE SET NULL;
...
--
-- Name: guest_sessions guest_sessions_entry_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.guest_sessions
    ADD CONSTRAINT guest_sessions_entry_device_id_fkey FOREIGN KEY (entry_device_id) REFERENCES public.devices(device_id);


--
-- Name: guest_sessions guest_sessions_exit_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.guest_sessions
    ADD CONSTRAINT guest_sessions_exit_device_id_fkey FOREIGN KEY (exit_device_id) REFERENCES public.devices(device_id);
...
--
-- Name: parking_sessions parking_sessions_entry_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.parking_sessions
    ADD CONSTRAINT parking_sessions_entry_device_id_fkey FOREIGN KEY (entry_device_id) REFERENCES public.devices(device_id);


--
-- Name: parking_sessions parking_sessions_exit_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.parking_sessions
    ADD CONSTRAINT parking_sessions_exit_device_id_fkey FOREIGN KEY (exit_device_id) REFERENCES public.devices(device_id);
...
\unrestrict Dfvf4lmMjLX2hmm1N7qvf5XE5lzFuAz7fCP60odoQXOZ74rHk1xzgZ5OaFGSbwd
